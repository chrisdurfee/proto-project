...
use Modules\User\Main\Storage\UserStorage;
...
use Modules\User\Organization\Models\Organization;
 ...
 * @property int $marketingOptIn
 * @property string|null $acceptedTermsAt
 * @property int $trialMode
 * @property int $trialDaysLeft
