...
This document explains how Proto handles bind mounts for seamless development across different installation scenarios.

## Overview

Proto uses a **hybrid approach** that combines:
