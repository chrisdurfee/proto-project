...
/**
 * Creates a list item component for a given route.
 *
 * @param {object} route - The route object.
 * @returns {function} - A function that takes a conversation and returns a ThreadListItem.
 */
export const ListItemCreator = (route) => (conversation) => ThreadListItem(conversation, route);