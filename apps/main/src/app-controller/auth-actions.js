 ...
 * record into local storage, and bring up the notification and
 * push channels (when configured).
 *
 ...
 * signOut
 *
 * Tear down realtime channels, hit the logout endpoint, clear
 * the persisted user, and force-reload to the app root so any
 * in-memory state is dropped along with the session cookie.
 *
 * @param {object} self - AppController instance.
 * @returns {void}
 */
export const signOut = (self) =>
{
	...
	self.data.notifications.teardown();
