 ...
 * AppController
 *
 * Main app controller. Wires routing, user/auth/
 * notification data, the service worker, CSRF, font
 * loading, and renders the AppShell.
 *
 ...
 *   - app-controller/user-data.js        — createUserData /
 *                                           mergeAndStoreUser
 *   - app-controller/auth-actions.js     — signIn / signOut
 *   - app-controller/bootstrap.js        — bootstrap /
 *                                           renderShell /
 *                                           setupRouter /
 *                                           createDataLayer
 *
