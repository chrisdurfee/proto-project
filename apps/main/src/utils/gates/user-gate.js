 ...
 * @returns {boolean}
 */
export const userHasPermission = (roles, permissionSlug) =>
{
	if (userIsAdmin())
	{
		return true;
 ...
 * @returns {boolean}
 */
export const userHasAnyPermission = (roles, permissionSlugs) =>
{
	if (userIsAdmin())
	{
		return true;
 ...
 * @returns {boolean}
 */
export const userIsOwner = (resourceId) =>
{
	const userData = getAppUser();
	if (!userData)
	{
	...
	return userData.id == resourceId;
};

/**
 * Checks if the user is not the owner of a resource.
 *
 * @param {number|string} resourceId
 * @returns {boolean}
 */
export const userIsNotOwner = (resourceId) =>
{
	const userData = getAppUser();
	if (!userData)
	{
